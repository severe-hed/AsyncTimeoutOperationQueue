...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AsyncTimeoutOperationQueue.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'severehed' => 'severehed@gmail.com' }
  ...
  # s.resource_bundles = {
  #   'AsyncTimeoutOperationQueue' => ['AsyncTimeoutOperationQueue/Assets/*.png']
  # }
